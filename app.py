...
def create_text_image(text, size=(VIDEO_WIDTH, VIDEO_HEIGHT), font_size=FONT_SIZE, font_color=FONT_COLOR, transparent_background=TRANSPARENT_BLACK):
    ...
    # Ajustamos la altura de línea en función del tamaño de la fuente.
...
# Nueva función para crear la imagen de suscripción (SIN MODIFICAR)
...
# Función de creación de video (MODIFICADA)
def create_simple_video(texto, nombre_salida, voz, logo_url):
    ...
    try:
        ...
        for i, segmento in enumerate(segmentos_texto):
            ...
            # Creamos la imagen con fondo transparente
        ...
        # Añadir clip de suscripción (SIN MODIFICAR)
        ...
        # Configuración del video (MODIFICADA)
...
# Interfaz de Streamlit (SIN MODIFICAR)
def main():
    ...
    if uploaded_file:
        ...
        if st.session_state.get("video_path"):
            st.markdown(f'<a href="https://www.youtube.com/upload" target="_blank">Subir video a YouTube</a>',
