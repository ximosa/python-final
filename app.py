...
try:
  if "GOOGLE_CREDENTIALS" in os.environ:
    ...
    logging.info("Credenciales de Google Cloud cargadas desde st.secrets.")
  ...
  logging.info("Variable de entorno GOOGLE_APPLICATION_CREDENTIALS establecida.")
    ...
    logging.error("La variable de entorno GOOGLE_CREDENTIALS no está configurada o gcp_service_account no configurado en st.secrets")
    st.error("La variable de entorno GOOGLE_CREDENTIALS no está configurada o gcp_service_account no configurado en st.secrets.")
    st.stop()
